# Guía Digital — Colcha Suites 2

## Propósito del proyecto
Este directorio contiene una **guía digital** para los huéspedes del apartamento Colcha Suites 2 (Calle Colcha, Granada). El objetivo es ofrecer toda la información práctica del alojamiento (acceso, normas, electrodomésticos, recomendaciones de la zona, contacto, etc.) en un formato digital fácil de consultar.

## Contexto
- Propietario / gestor: apartamentosreyescatolicos@gmail.com
- Repositorio remoto: https://github.com/apartamentosreyescatolicos-max/guia-colcha-suites-2
- Publicado con GitHub Pages en: https://apartamentosreyescatolicos-max.github.io/guia-colcha-suites-2/
- El repo contiene exclusivamente la guía de Colcha Suites 2.

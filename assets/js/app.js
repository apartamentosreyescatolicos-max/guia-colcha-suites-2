/* =========================================================
   Guía Colcha Suites 2 · interacciones del cliente
   ========================================================= */
...
(() => {
  ...
  const I18N = {
    es: {
      ...
      'footer.sign': 'Colcha Suites 2 · Calle Colcha · Granada',
  ...
  function applyLang(lang) {
    ...
    try { localStorage.setItem('colchasuites2.lang', lang); } catch (_) {}
  }
  ...
  let savedLang = null;
  try { savedLang = localStorage.getItem('colchasuites2.lang'); } catch (_) {}
